...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  price: 100,
  state: 1,
  category_id: Category.where(name: "Snack").id,
  user_id: User.sample,
  duration: 10,
  ...
  price: 0,
  state: 1,
  category_id: Category.where(name: "Sightseeing").id,,
  user_id: User.sample,
  duration: 20,
  ...
  price: 500,
  state: 1,
  category_id: Category.where(name: "Museum").id,,
  user_id: User.sample,
  duration: 60,
  ...
  price: 1500 ,
  state: 1,
  category_id: Category.where(name: "Tour").id,,
  user_id: User.sample,
  duration: 120,
  ...
  price: 200 ,
  state: 1,
  category_id: Category.where(name: "Park").id,,
  user_id: User.sample,
  duration: 45,
